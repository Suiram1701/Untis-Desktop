...
{
    public static readonly CultureInfo[] s_SupportedCultures = new CultureInfo[6]
    {
        new("de"),
        new("en"),
        new("es"),
    ...
    /// </summary>
    /// <remarks>
    /// If culture to set isn't available the culture doesn't change
    /// </remarks>
    public static CultureInfo Culture
    {
        ...
        set
        {
            if (s_SupportedCultures.Any(lang => value.Name.Contains(lang.Name)))
                s_Culture = value;
        }
    }
    ...
    /// </summary>
    private static readonly ResourceManager s_ResManager = new("UntisDesktop.Localization.Strings", Assembly.GetExecutingAssembly());
